...
class _CardTypeAtcModalState extends State<CardTypeAtcModal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        IziText.title(
            color: context.iziColors.dark, text: LocaleKeys.payment_subtitles_chooseCardPaymentType.tr()),
        ...
        Flexible(
          child: GridView.count(
            ...
            shrinkWrap: true,
            children: [
              _buttonPayment(context,title: LocaleKeys.payment_buttons_chip.tr(), icon: Icons.sim_card_outlined, ru: ru,type: 1),
              _buttonPayment(context,title: LocaleKeys.payment_buttons_contactless.tr(), icon: Icons.contactless_outlined, ru: ru,type: 2),
            ],
          ),
        ),
        const SizedBox(height: 16,),
